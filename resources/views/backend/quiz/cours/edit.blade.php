...
@section('content')
    ...
    {!! Form::model( $cour ,['route' => ['admin.quiz.cour.update' , $cour->id ], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'patch']) !!}
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-lg-10">
                {!! Form::select('departement_id[]' , $departements , $DepartementsToDisplay, ['class'=>'form-control' ,  'multiple' => 'multiple']) !!}
