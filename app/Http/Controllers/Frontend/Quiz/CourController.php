        ...
        $output ='<?xml version="1.0" encoding="utf-8" ?>
                    <data>
                        ...
                        <box id="openingText" position="relative" anim="left" animtime="0.5" animdelay="1" class="col-md-10 col-md-offset-1 vertical-align" z-index="3">
                            ...
                            <text id="title" position="relative" margin-top="300" anim="none"><![CDATA[<h1 class="black">Multiple Choice Quiz Engine</h1><p class="p_16_black">Welcome to this short quiz.</p><p class="p_16_black">For each question, select the answer before your time runs out!</p>]]></text>
                        ...
                        <custom type="quiz" id="quiz" position="relative" x="0" y="0" class="col-md-10 col-md-offset-1">
                            ...
                            <timeout>
                                <box id="center" position="relative" height="100%"> 
                                    <box id="timeOut" position="relative" height="350" margin-top="300" margin-bottom="20" anim="left" animtime="1" ease="Bounce.easeOut" class="col-sm-8 col-sm-offset-2 vertical-align border timesupbg">
                            ...
                            <score masteryscore="80">
                               <fb id="pass" event="">
                                    <box id="center" position="relative" height="100%">
                                        <box id="passTextBox" position="relative" height="350" margin-top="200" margin-bottom="20" anim="left" animtime="0.5" class="col-sm-8 col-sm-offset-2 vertical-align border passbg">
                                ...
                                <fb id="fail" event="">
                                <box id="center" position="relative" height="100%">
                                        <box id="failTextBox" position="relative" height="350" margin-top="200" margin-bottom="20" anim="left" animtime="0.5" class="col-sm-8 col-sm-offset-2 vertical-align border failbg">
